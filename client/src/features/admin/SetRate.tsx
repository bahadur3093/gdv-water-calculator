      ...
      <div className="lg:max-w-2xl">
            ...
            <div className="flex items-end gap-4">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">
                  ...
                  {typeof currentRate.setBy === "object" &&
                  (currentRate.setBy as any)?.name
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            {currentRate && (
              <div className="text-xs text-gray-400 lg:mb-2 text-right">
                This will apply to all new bills going forward. Existing bills
                are unaffected.
              </div>
            )}
                ...
                <table className="w-full min-w-[640px] text-sm">
                  <thead>
                    <tr className="bg-gray-50 text-left border-b border-gray-100">
                      <th className="sticky left-0 z-20 bg-white px-5 py-3 font-medium text-gray-500">
                        Rate
                      </th>
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {allRates.map((r, i) => (
                      ...
                      >
                        <td className="sticky left-0 z-10 bg-white px-5 py-3.5 font-medium text-gray-900">
